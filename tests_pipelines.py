...
if __name__ == '__main__':
    ...
    # Create Test Loader
    test_dir ='dataset/combined_cropped/test'
    ...
    # nature_SR_model.load_state_dict(torch.load('models_weights/nature_model_L2_4X_simple_transform_psnr_28.126078005152074_ssim_0.7842229293047926.pth', map_location=torch.device('cpu')))
    # man_made_SR_model.load_state_dict(torch.load('models_weights/man_made_model_L2_4X_simple_transform_psnr_26.053848260689684_ssim_0.7579843133961389.pth', map_location=torch.device('cpu')))
    # classifier_model = torch.load('models_weights/classifier_100_epochs.pth', map_location=torch.device('cpu'))
    baseline_SR_model.load_state_dict(torch.load('models_weights/baseline_model_L1_4X_psnr_27.378690308017333_ssim_0.7839492559432983.pth', map_location=torch.device('cpu')))
