...
def train(model, trainloader, validloader, criterion, optimizer, num_epochs, device='cpu'):
    model.train()
    ...
    for epoch in range(num_epochs):
        ...
        if avg_psnr_sr > max_valid_psnr:
            ...
            torch.save(model.state_dict(), f'checkpoints_combined_500_on_man_made_val/best_unet_model_4X_combined_500_man_made_val_psnr_{max_valid_psnr}_ssim_{avg_ssim_sr}.pth')
...
def main():
    ...
    train_dir = 'dataset/combined_500/train'
    valid_dir = 'dataset/man_made_500/val'
    ...
    train(model, trainloader, validloader, criterion, optimizer, config['epochs'], device)
